...
namespace MVC_ONION_PROJECT.INFRASTRUCTURE.Migrations
{
    ...
    [Migration("20230918050445_advancepaymentmig")]
    partial class advancepaymentmig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MVC_ONION_PROJECT.DOMAIN.ENTITIES.EmployeeDebit", b =>
                {
                    ...
                    b.HasOne("MVC_ONION_PROJECT.DOMAIN.ENTITIES.OrgAsset", "OrgAsset")
                        .WithOne("EmployeeDebit")
                        .HasForeignKey("MVC_ONION_PROJECT.DOMAIN.ENTITIES.EmployeeDebit", "OrgAssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
