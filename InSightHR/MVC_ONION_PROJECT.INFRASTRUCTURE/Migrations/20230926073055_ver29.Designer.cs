...
namespace MVC_ONION_PROJECT.INFRASTRUCTURE.Migrations
{
    ...
    [Migration("20230926073055_ver29")]
    partial class ver29
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVC_ONION_PROJECT.DOMAIN.ENTITIES.Organization", b =>
                {
                    ...
                    b.Property<int>("EmployeeOfNumber")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC_ONION_PROJECT.DOMAIN.ENTITIES.Package", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("PackageDurationMonth")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("MVC_ONION_PROJECT.DOMAIN.ENTITIES.Reimbursement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<byte[]>("ExpenseAttachments")
                        .IsRequired()
                        .HasMaxLength(255)
            ...
            modelBuilder.Entity("MVC_ONION_PROJECT.DOMAIN.ENTITIES.Organization", b =>
                {
                    b.HasOne("MVC_ONION_PROJECT.DOMAIN.ENTITIES.Package", "Package")
                        .WithMany("Departments")
